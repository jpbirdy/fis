...
class Fis_Crypt_CFcrypt
{
    ...
    function getEncodeStrByPicId($intId1, $intId2 = 1982721)
    {
        if (($intId1 & 0xFFFFFFFF80000000) != 0)
        {
            ...
            $strtmp = pack('L', $intId2 & 0x00000000FFFFFFFF) . pack('L', ($intId2 & 0xFFFFFFFF00000000) >> 32) . pack('L', $intId1 & 0x00000000FFFFFFFF) . pack('L', ($intId1 & 0xFFFFFFFF00000000) >> 32);
        }
        else
        {
