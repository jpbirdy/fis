...
class Fis_String
{
     ...
     * @example:
	 * Fis_String::bdstrpos('a-b-c-d-', '-', 2);
     * '_'第2次在'a-b-c-d-'中出现的返回值为：4
     *
     * Fis_String::bdstrpos('a-b-c-d-', '-', 3);
	 ...
	 *
     * @example:
     * Fis_String::substring('abca/need/asdfas', '/');
     * 返回 'need', 两个'/'之间的字符串
	 *
     * Fis_String::substring('ab!before!need===', '!', '===')
     * 返回 'before!need'之间的字符串
	 *
     * Fis_String::substring('ab!before!need===', '!', '===', 1)
	 * 返回 'need',  === 之前最近一个!号间的字
	 *
	 * @author chenqiuwu(chenqiuwu@baidu.com)
     */
     ...
     *
     * @brief 截取某个字符串前几位字符
     * @examle echo Fis_String::cutBefore('ab!before!need===', '===', 4); //返回 need
     *
	 * @author chenqiuwu(chenqiuwu@baidu.com)
     */
